...
const Header = () => {
  ...
  const headers = [
    ...
    },
    {
      title: "Report",
      link: "/report",
      logo:<svg xmlns="http://www.w3.org/2000/svg" width="30" height="25"  fill="currentColor" className="  bi-file-earmark-bar-graph" viewBox="0 0 16 16">
    ...
    },
    {
      title: "Task",
      link: "/task",
      logo:<svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" className="bi bi-envelope-plus" viewBox="0 0 16 16">
    ...
    },
    {
      ...
      title: "Preview",
      link: "/preview",
      logo:<svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" className="bi bi-eye" viewBox="0 0 16 16">
    ...
    },
    {
      title: "Project",
      link: "/project",
      logo:<svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" className="bi bi-briefcase" viewBox="0 0 16 16">
  ...
  return (
    <>
    <div className={`   ${
          sideMenu ? "fixed h-screen w-screen z-10 bg-transparent" : "hidden"}`} onClick={()=>{
      setSideMenu(false);
    }}>
      ...
      >
        {headers?.map((header,i)  => {
          if  (header.title === "Home") {
            ...
            return (
              <Link
              className={`${path.pathname === header.link ? 'w-full   p-3 rounded-md flex gap-6 items-center text-white font-bold bg-slate-400' : 'w-full bg-slate-300 p-3 rounded-md flex gap-6 items-center '}`}
